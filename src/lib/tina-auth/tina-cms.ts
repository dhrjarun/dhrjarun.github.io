import type { Collection, LoginStrategy } from '@tinacms/schema-tools';
import { getCsrfToken, getSession, signIn, signOut, SessionProvider } from 'next-auth/react';
...
export class DefaultAuthJSProvider extends AbstractAuthProvider {
  ...
  constructor(props?: { name?: string; callbackUrl?: string; redirect?: boolean }) {
    super();
